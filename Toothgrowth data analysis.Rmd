...
Conclusion: 1.Different methods of intaking the drug between VC and OJ do not impact toothgrowth, the difference between toothlength of OJ group and VC group is not significant. 2. Increaseing the dose of the drug from low(0.5) to median(1) significantly promotes toothgrowth. However, further increasing drug dosage from 1 to 2 does not accelerate toothgrowth.
