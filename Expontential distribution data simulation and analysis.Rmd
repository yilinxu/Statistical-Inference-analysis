---
title: "Expotential distribution data simulation and analysis"
author: "Yilin"
date: "February 12, 2016"
output: pdf_document
---
Overview: Simulate 40*1000 expotential distribution data with lambda=0.2, calculate the mean and standard deviation of the 40 exponentials' mean. Compare the result with the theoretical result, mean=1/lambda, sd=1/lambda. 

1.1000*40 simulations of expotential distribution data  
```{r}
